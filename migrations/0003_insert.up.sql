...
(5, 'Contador', 'Encargado de la contabilidad y finanzas'),
(6, 'Recursos Humanos', 'Encargado de la gestión del personal'),
(7, 'Soporte Técnico', 'Responsable de la asistencia técnica'),
(8, 'Analista de Datos', 'Analiza y genera reportes para la empresa');
...
INSERT INTO users (id, password, role_id, username, avatar, email, settings, shortcuts)
VALUES (
    1,
...
INSERT INTO companies (id, name, ruc, email, phone, address, status, created_by) VALUES
(1, 'Ferretería San Juan S.A.', '20123456789', 'contacto@ferresanjuan.com', '015678901', 'Av. Universitaria 1234, Lima, Perú', B'1', 1),
(2, 'Materiales del Norte SAC', '20456789012', 'ventas@matnorte.com', '016543210', 'Calle Comercio 456, Trujillo, Perú', B'1', 1);

-- Insertar datos en la tabla sucursales
INSERT INTO branch_offices (id, company_id, name, address, phone, status, created_by) VALUES
(1, 1, 'Sucursal Lima', 'Av. Aviación 2345, Lima, Perú', '014567890', B'1', 1),
(2, 1, 'Sucursal Arequipa', 'Calle Mercaderes 789, Arequipa, Perú', '054678901', B'1', 1),
(3, 1, 'Sucursal Cusco', 'Av. El Sol 555, Cusco, Perú', '084567123', B'1', 1),
(4, 1, 'Sucursal Chiclayo', 'Calle Balta 789, Chiclayo, Perú', '074678345', B'1', 1),
(5, 2, 'Sucursal Trujillo', 'Av. América Norte 123, Trujillo, Perú', '044345678', B'1', 1),
(6, 2, 'Sucursal Piura', 'Av. Grau 432, Piura, Perú', '073567890', B'1', 1),
(7, 2, 'Sucursal Tacna', 'Jr. Bolognesi 210, Tacna, Perú', '052678234', B'1', 1),
(8, 2, 'Sucursal Huancayo', 'Calle Real 678, Huancayo, Perú', '064345789', B'1', 1);

-- Insertar datos en la tabla almacenes
INSERT INTO warehouses (id, branch_office_id, name, description, address, status, created_by) VALUES
(1, 1, 'Almacén Central Lima', 'Almacén principal en Lima', 'Av. Aviación 2345, Lima, Perú', B'1', 1),
(2, 1, 'Depósito Lima', 'Depósito de materiales', 'Calle Industrial 567, Lima, Perú', B'1', 1),
(3, 2, 'Almacén Arequipa', 'Centro de distribución en el sur', 'Calle Mercaderes 789, Arequipa, Perú', B'1', 1),
(4, 3, 'Almacén Cusco', 'Depósito de herramientas en Cusco', 'Av. El Sol 555, Cusco, Perú', B'1', 1),
(5, 4, 'Almacén Chiclayo', 'Depósito de ferretería en Chiclayo', 'Calle Balta 789, Chiclayo, Perú', B'1', 1),
(6, 5, 'Almacén Trujillo', 'Almacén central en Trujillo', 'Av. América Norte 123, Trujillo, Perú', B'1', 1),
(7, 6, 'Almacén Piura', 'Depósito de materiales en Piura', 'Av. Grau 432, Piura, Perú', B'1', 1),
(8, 7, 'Almacén Tacna', 'Centro de distribución en Tacna', 'Jr. Bolognesi 210, Tacna, Perú', B'1', 1),
(9, 8, 'Almacén Huancayo', 'Depósito de herramientas en Huancayo', 'Calle Real 678, Huancayo, Perú', B'1', 1);
...
INSERT INTO work_areas (id, name, description, created_by) VALUES
(1, 'Desarrollo de Software', 'Área encargada del desarrollo de aplicaciones', 1),
(2, 'Recursos Humanos', 'Gestión de personal y administración', 1),
(3, 'Finanzas', 'Gestión financiera y contabilidad', 1),
(4, 'Logística', 'Manejo de inventarios y distribución', 1),
(5, 'Marketing', 'Publicidad y estrategias de mercado', 1);

-- Insertar datos en la tabla job_positions
INSERT INTO job_positions (id, work_area_id, name, description, created_by) VALUES
(1, 1, 'Ingeniero de Software', 'Desarrollo de aplicaciones y sistemas', 1),
(2, 1, 'Arquitecto de Software', 'Diseño y planificación de sistemas complejos', 1),
(3, 2, 'Gerente de Recursos Humanos', 'Supervisión del área de RRHH', 1),
(4, 2, 'Especialista en Reclutamiento', 'Búsqueda y selección de personal', 1),
(5, 3, 'Analista Financiero', 'Gestión de análisis financiero y reportes', 1),
(6, 4, 'Coordinador de Logística', 'Gestión de almacenes y transporte', 1),
(7, 5, 'Especialista en Marketing Digital', 'Estrategias de marketing online', 1);
...
(1, 'IGV', 'Impuesto General a las Ventas (18%)', 18.00, B'0', 1),
(2, 'ISC', 'Impuesto Selectivo al Consumo', 10.00, B'0', 1),
(3, 'Percepción', 'Percepción de IGV', 2.00, B'0', 1),
(4, 'Retención', 'Retención del IGV', 3.00, B'0', 1),
(5, 'Impuesto Fijo', 'Ejemplo de impuesto con monto fijo', 5.00, B'1', 1);
...
(1, 'Herramientas Manuales', 'Categoría para herramientas como martillos, destornilladores, llaves, etc.', B'1', 1),
(2, 'Herramientas Eléctricas', 'Categoría para taladros, sierras eléctricas, lijadoras y otras herramientas eléctricas.', B'1', 1),
(3, 'Materiales de Construcción', 'Materiales como cemento, ladrillos, arena y piedra.', B'1', 1),
(4, 'Pinturas y Acabados', 'Pinturas, barnices, brochas, rodillos y accesorios para acabados.', B'1', 1),
(5, 'Plomería', 'Tubos, conexiones, válvulas, llaves de paso y artículos de plomería.', B'1', 1),
(6, 'Electricidad', 'Cables, enchufes, interruptores, luminarias y artículos eléctricos.', B'1', 1),
(7, 'Jardinería', 'Herramientas de jardinería, fertilizantes, semillas y macetas.', B'1', 1),
(8, 'Seguridad Industrial', 'Cascos, guantes, gafas de seguridad y ropa reflectante.', B'1', 1),
(9, 'Adhesivos y Selladores', 'Siliconas, pegamentos, masillas y selladores de todo tipo.', B'1', 1),
(10, 'Tornillería y Fijaciones', 'Tornillos, clavos, pernos, tuercas y arandelas.', B'1', 1),
(11, 'Cerraduras', 'Cerraduras para puertas de todo tipo, incluyendo residenciales y comerciales.', B'1', 1),
(12, 'Ferretería General', 'Bisagras, rieles, soportes y artículos generales.', B'1', 1),
(13, 'Automatización y Domótica', 'Motores, sistemas de automatización y dispositivos de domótica.', B'1', 1),
(14, 'Maquinaria Pesada', 'Pequeña maquinaria como mezcladoras, compactadoras y otros equipos.', B'1', 1),
(15, 'Accesorios para Baño y Cocina', 'Grifería, accesorios para baño y artículos para cocina.', B'1', 1),
(16, 'Vidrio y Acrílicos', 'Cristales, acrílicos y materiales relacionados.', B'1', 1),
(17, 'Equipos de Medición', 'Cintas métricas, niveles, calibradores y otros instrumentos de medición.', B'1', 1),
(18, 'Maderas y Derivados', 'Tablas, triplay, MDF y otros derivados de madera.', B'1', 1),
(19, 'Sistemas de Riego', 'Tuberías, aspersores y equipos para riego.', B'1', 1),
(20, 'Calentadores y Climatización', 'Calentadores, ventiladores y aire acondicionado.', B'1', 1),
(21, 'Candados', 'Candados de seguridad de diferentes niveles de protección.', B'1', 1),
(22, 'Cilindros', 'Cilindros para cerraduras y sistemas de seguridad.', B'1', 1),
(23, 'Cerrojos', 'Sistemas de cerrojos manuales y automáticos.', B'1', 1),
(24, 'Accesorios de Cerrajería', 'Componentes y accesorios para sistemas de cerrajería.', B'1', 1);

-- Insertar datos en la tabla brands
INSERT INTO brands (id, name, description, logo_url, website_url, status, created_by) VALUES
(1, 'DeWalt', 'Fabricante de herramientas eléctricas y accesorios para profesionales y aficionados.', 'https://example.com/logos/dewalt.png', 'https://www.dewalt.com', B'1', 1),
(2, 'Bosch', 'Marca reconocida por herramientas eléctricas, electrodomésticos y tecnología industrial.', 'https://example.com/logos/bosch.png', 'https://www.bosch.com', B'1', 1),
(3, 'Stanley', 'Líder en herramientas manuales, medidores y productos de almacenamiento.', 'https://example.com/logos/stanley.png', 'https://www.stanleytools.com', B'1', 1),
(4, 'Makita', 'Proveedor global de herramientas eléctricas y equipos industriales.', 'https://example.com/logos/makita.png', 'https://www.makitatools.com', B'1', 1),
(5, 'Black+Decker', 'Fabricante de herramientas eléctricas, jardinería y electrodomésticos.', 'https://example.com/logos/blackdecker.png', 'https://www.blackanddecker.com', B'1', 1),
(6, 'Truper', 'Empresa líder en herramientas manuales, eléctricas y accesorios de ferretería.', 'https://example.com/logos/truper.png', 'https://www.truper.com', B'1', 1),
(7, 'Klein Tools', 'Fabricante de herramientas manuales y equipos eléctricos de alta calidad.', 'https://example.com/logos/klein.png', 'https://www.kleintools.com', B'1', 1),
(8, 'Hilti', 'Proveedor especializado en herramientas y sistemas de fijación para construcción.', 'https://example.com/logos/hilti.png', 'https://www.hilti.com', B'1', 1),
(9, 'Fischer', 'Expertos en soluciones de fijación y anclajes para construcción.', 'https://example.com/logos/fischer.png', 'https://www.fischer.com', B'1', 1),
(10, 'RIDGID', 'Marca especializada en herramientas para plomería y construcción.', 'https://example.com/logos/ridgid.png', 'https://www.ridgid.com', B'1', 1),
(11, 'Irwin', 'Fabricante de herramientas de corte, sujeción y perforación.', 'https://example.com/logos/irwin.png', 'https://www.irwin.com', B'1', 1),
(12, '3M', 'Líder en productos industriales como adhesivos, cintas, abrasivos y más.', 'https://example.com/logos/3m.png', 'https://www.3m.com', B'1', 1),
(13, 'Troy-Bilt', 'Especialista en herramientas y equipos de jardinería.', 'https://example.com/logos/troybilt.png', 'https://www.troybilt.com', B'1', 1),
(14, 'Husqvarna', 'Fabricante de herramientas para jardinería, agricultura y construcción.', 'https://example.com/logos/husqvarna.png', 'https://www.husqvarna.com', B'1', 1),
(15, 'Craftsman', 'Marca confiable en herramientas manuales, eléctricas y almacenamiento.', 'https://example.com/logos/craftsman.png', 'https://www.craftsman.com', B'1', 1),
(16, 'Milwaukee', 'Proveedor de herramientas eléctricas y accesorios de alta calidad.', 'https://example.com/logos/milwaukee.png', 'https://www.milwaukeetool.com', B'1', 1),
(17, 'Metabo', 'Especialista en herramientas eléctricas y accesorios industriales.', 'https://example.com/logos/metabo.png', 'https://www.metabo.com', B'1', 1),
(18, 'Bostitch', 'Fabricante de herramientas de fijación como engrampadoras y clavos.', 'https://example.com/logos/bostitch.png', 'https://www.bostitch.com', B'1', 1),
(19, 'Simpson Strong-Tie', 'Líder en soluciones de anclaje y conectores estructurales.', 'https://example.com/logos/simpson.png', 'https://www.strongtie.com', B'1', 1),
(20, 'Paslode', 'Fabricante de herramientas de fijación neumáticas y a gas.', 'https://example.com/logos/paslode.png', 'https://www.paslode.com', B'1', 1),
(21, 'Assa Abloy', 'Líder mundial en soluciones de apertura de puertas, incluyendo cerraduras y sistemas de seguridad.', 'https://example.com/logos/assaabloy.png', 'https://www.assaabloy.com', B'1', 1),
(22, 'Mul-T-Lock', 'Fabricante de sistemas de cerraduras de alta seguridad.', 'https://example.com/logos/multlock.png', 'https://www.mul-t-lock.com', B'1', 1),
(23, 'Medeco', 'Especialistas en cerraduras de alta seguridad y sistemas de llaves controladas.', 'https://example.com/logos/medeco.png', 'https://www.medeco.com', B'1', 1),
(24, 'Kwikset', 'Fabricante de cerraduras residenciales y sistemas de llaves inteligentes.', 'https://example.com/logos/kwikset.png', 'https://www.kwikset.com', B'1', 1),
(25, 'Schlage', 'Marca reconocida en cerraduras residenciales y comerciales.', 'https://example.com/logos/schlage.png', 'https://www.schlage.com', B'1', 1),
(26, 'Yale', 'Pioneros en cerrajería con más de 180 años de experiencia.', 'https://example.com/logos/yale.png', 'https://www.yale.com', B'1', 1),
(27, 'Master Lock', 'Fabricante líder de candados y soluciones de seguridad.', 'https://example.com/logos/masterlock.png', 'https://www.masterlock.com', B'1', 1),
(28, 'ABUS', 'Especialistas en candados y sistemas de seguridad de alta calidad.', 'https://example.com/logos/abus.png', 'https://www.abus.com', B'1', 1),
(29, 'EVVA', 'Fabricante austriaco de sistemas de cerraduras de alta seguridad.', 'https://example.com/logos/evva.png', 'https://www.evva.com', B'1', 1),
...
'img-06',
'[{"url":"uploads/images/products/11-512x512.jpg","featured":"img-06"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
'img-07',
'[{"url":"uploads/images/products/12-512x512.jpg","featured":"img-07"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
'img-08',
'[{"url":"uploads/images/products/13-160x160.jpg","featured":"img-08"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
'img-09',
'[{"url":"uploads/images/products/14-640x480.jpg","featured":"img-09"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
'img-10',
'[{"url":"uploads/images/products/15-640x480.jpg","featured":"img-10"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
'img-11',
'[{"url":"uploads/images/products/16-640x480.jpg","featured":"img-11"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
'img-12',
'[{"url":"uploads/images/products/17-640x480.jpg","featured":"img-12"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
'img-13',
'[{"url":"uploads/images/products/18-640x480.jpg","featured":"img-13"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
'img-14',
'[{"url":"uploads/images/products/19-640x480.jpg","featured":"img-14"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
'img-15',
'[{"url":"uploads/images/products/20-640x480.jpg","featured":"img-15"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
'img-16',
'[{"url":"uploads/images/products/21-640x480.jpg","featured":"img-16"}]'::jsonb,
'[
    {
        "id": 1,
        "name": "price_1",
...
VALUES 
(1, 'Efectivo', 'Pago en efectivo', B'1', 1),
(2, 'Tarjeta de Crédito', 'Pago con tarjeta de crédito', B'1', 1),
(3, 'Transferencia Bancaria', 'Pago por transferencia bancaria', B'1', 1),
(4, 'Yape', 'Pago mediante Yape', B'1', 1),
(5, 'Plin', 'Pago mediante Plin', B'1', 1);
...
(1, 'A Walk Amongst Friends - Canvas Print', 1, 1, 1, B'0', NULL, 10.24, 10.24, 10.24),
(2, 'A Walk Amongst Friends - Canvas Print', 2, 1, 2, B'0', NULL, 10.24, 20.48, 20.48),
(3, 'A Walk Amongst Friends - Canvas Print', 3, 1, 5, B'0', NULL, 10.24, 51.20, 51.20);
...
VALUES
(1, 'OC-00001', 1, 1, 6, 3.75, 5.00, '2024-07-01 10:00:00', 10.00, 180.00, 198.00, 'canceled', 1, B'0'),
(2, 'OC-00002', 2, 2, 6, 3.70, 0.00, '2024-07-03 15:30:00', 8.00, 240.00, 259.20, 'approved', 1, B'0'),
(3, 'OC-00003', 3, 3, 6, 3.80, 10.00, '2024-07-05 12:45:00', 9.50, 500.00, 547.50, 'partial', 1, B'1'),
(4, 'OC-00004', 4, 4, 6, 3.85, 3.00, '2024-07-07 09:20:00', 7.00, 300.00, 321.00, 'rejected', 1, B'0'),
(5, 'OC-00005', 5, 5, 6, 3.78, 5.00, '2024-07-09 14:10:00', 6.50, 420.00, 447.30, 'approved', 1, B'0'),
(6, 'OC-00006', 6, 6, 6, 3.79, 8.00, '2024-07-11 17:50:00', 8.20, 350.00, 378.70, 'partial', 1, B'1'),
(7, 'OC-00007', 7, 7, 6, 3.76, 2.00, '2024-07-13 11:05:00', 7.80, 275.00, 296.45, 'received', 1, B'0'),
(8, 'OC-00008', 8, 8, 6, 3.77, 0.00, '2024-07-15 13:25:00', 8.50, 600.00, 648.00, 'rejected', 1, B'0'),
(9, 'OC-00009', 9, 9, 6, 3.74, 4.00, '2024-07-17 16:40:00', 9.00, 480.00, 523.20, 'approved', 1, B'1'),
(10, 'OC-00010', 2, 10, 6, 3.80, 6.00, '2024-07-19 10:10:00', 7.50, 550.00, 591.25, 'received', 1, B'0');
...
INSERT INTO sales (id, document_type, series, number, bill, issue_date, warehouse_id, customer_id, currency_id, user_id, exchange_rate, discount, subtotal, total, total_paid, change, sale_status, payment_method_id, sale_order_id)
VALUES
...
VALUES
(1, 'Laptop HP', 1, 1, 2, B'1', 5.00, 50.00, 100.00, 113.00),
(2, 'Mouse Logitech', 1, 2, 1, B'1', 0.00, 20.00, 20.00, 22.60),
(3, 'Monitor LG', 2, 3, 1, B'1', 0.00, 200.00, 200.00, 236.00),
(4, 'Teclado Mecánico', 3, 4, 3, B'0', 10.00, 50.00, 150.00, 166.00),
(5, 'Silla Gamer', 4, 5, 1, B'1', 0.00, 180.00, 180.00, 212.40),
(6, 'Impresora Epson', 5, 6, 2, B'1', 5.00, 60.00, 120.00, 135.60),
(7, 'Tablet Samsung', 6, 7, 1, B'1', 0.00, 90.00, 90.00, 106.20),
(8, 'Disco Duro SSD', 7, 8, 3, B'0', 2.00, 100.00, 300.00, 354.00),
(9, 'Auriculares Sony', 8, 9, 2, B'1', 0.00, 55.00, 110.00, 124.30);
...
(1, 1, 'Nubefact API URL', 'URL base para conexión a la API de Nubefact', 'nubefact_api_url', 'https://api.nubefact.com/api/v1/e421b983-cc37-45ca-8bbf-b4b5e4af3136', B'1', 1),
(2, 1, 'Nubefact API Token', 'Token de autenticación para emisión de comprobantes en Nubefact', 'nubefact_api_token', '9a048f724546488eb4e3da7a46e27b110732865e97de49c5a07f930c57a45ffc', B'1', 1),
(3, 2, 'Odoo Base URL', 'URL base para conexión al servidor Odoo XML-RPC', 'odoo_base_url', 'https://erp.miempresa.com/xmlrpc/2/object', B'1', 1),
(4, 2, 'Odoo Database Name', 'Nombre de la base de datos de Odoo', 'odoo_db_name', 'erp_miempresa', B'1', 1),
(5, 2, 'Odoo Username', 'Usuario administrador de Odoo', 'odoo_username', 'admin', B'1', 1),
(6, 2, 'Odoo Password', 'Contraseña del usuario de Odoo', 'odoo_password', 'odooPass123', B'1', 1),
(7, 3, 'SUNAT SOL Username', 'Usuario SOL para conexión a SUNAT', 'sunat_sol_username', '20555555555MODDATOS', B'1', 1),
(8, 3, 'SUNAT SOL Password', 'Contraseña SOL del usuario para SUNAT', 'sunat_sol_password', 'miClaveSegura123', B'1', 1),
(9, 3, 'SUNAT URL Beta', 'URL del servicio web de SUNAT en ambiente de prueba', 'sunat_beta_url', 'https://e-beta.sunat.gob.pe/ol-ti-itcpfegem-beta/billService', B'1', 1),
(10, 3, 'SUNAT URL Producción', 'URL del servicio web de SUNAT en producción', 'sunat_prod_url', 'https://e-factura.sunat.gob.pe/ol-ti-itcpfegem/billService', B'1', 1),
(11, 3, 'SUNAT Certificate Path', 'Ruta del certificado digital para SUNAT', 'sunat_cert_path', '/certs/sunat_cert.pfx', B'1', 1),
(12, 3, 'SUNAT Certificate Password', 'Contraseña del certificado digital SUNAT', 'sunat_cert_password', 'certPassword123', B'1', 1),
(13, 4, 'SMTP Host', 'Servidor de correo SMTP', 'smtp_host', 'smtp.miempresa.com', B'1', 1),
(14, 4, 'SMTP Port', 'Puerto del servidor SMTP', 'smtp_port', '587', B'1', 1),
(15, 4, 'SMTP User', 'Correo electrónico utilizado para enviar los correos', 'smtp_user', 'noreply@miempresa.com', B'1', 1),
(16, 4, 'SMTP Password', 'Contraseña del correo SMTP', 'smtp_password', 'correoSuperSeguro123', B'1', 1),
(17, 4, 'SMTP Encryption', 'Método de cifrado utilizado (TLS o SSL, 1)', 'smtp_encryption', 'TLS', B'1', 1),
(18, 5, 'Culqi Public Key', 'Llave pública para el cliente en Culqi', 'culqi_public_key', 'pk_test_CULQIPUBLICKEY', B'1', 1),
(19, 5, 'Culqi Private Key', 'Llave secreta para operaciones en Culqi', 'culqi_private_key', 'sk_test_CULQIPRIVATEKEY', B'1', 1),
(20, 5, 'Culqi API URL', 'URL base para el servicio de Culqi', 'culqi_api_url', 'https://api.culqi.com/v2', B'1', 1),
(21, 5, 'MercadoPago Public Key', 'Llave pública para el cliente en MercadoPago', 'mercadopago_public_key', 'PUBLIC_MP_KEY', B'1', 1),
(22, 5, 'MercadoPago Access Token', 'Token de acceso privado de MercadoPago', 'mercadopago_access_token', 'ACCESS_TOKEN_MP', B'1', 1),
(23, 6, 'Sistema Nombre', 'Nombre de la empresa o sistema', 'system_name', 'ERP Mi Empresa', B'1', 1),
(24, 6, 'Sistema Modo', 'Modo del sistema (produccion/desarrollo, 1)', 'system_mode', 'produccion', B'1', 1),
(25, 6, 'JWT Secret', 'Llave secreta utilizada para firmar los JWT tokens', 'jwt_secret', 'jwtSuperSecret123456', B'1', 1),
(26, 6, 'Token Expiración', 'Tiempo de expiración del token JWT en minutos', 'jwt_expiration_minutes', '120', B'1', 1),
(27, 6, 'URL Frontend', 'URL del frontend del sistema', 'frontend_url', 'https://miempresa.app', B'1', 1),
(28, 6, 'URL Backend', 'URL del backend del sistema', 'backend_url', 'https://api.miempresa.com', B'1', 1),
(29, 7, 'Certificado SSL Path', 'Ruta donde se almacena el certificado SSL', 'ssl_cert_path', '/certs/ssl_cert.pem', B'1', 1),
(30, 7, 'Llave Privada SSL Path', 'Ruta donde se almacena la llave privada del SSL', 'ssl_private_key_path', '/certs/ssl_key.pem', B'1', 1),
(31, 7, 'Certificado SSL Password', 'Contraseña para el acceso al certificado SSL si aplica', 'ssl_cert_password', 'sslPassword123', B'1', 1),
(32, 7, 'Certificado SUNAT PFX', 'Ruta del archivo PFX del certificado digital SUNAT', 'sunat_cert_pfx_path', '/certs/sunat_cert.pfx', B'1', 1),
(33, 7, 'Password SUNAT PFX', 'Password del archivo PFX de SUNAT', 'sunat_cert_pfx_password', 'pfxPassword321', B'1', 1);
...
(1, 'Licencia por Paternidad', 'LPAT', 'Licencia por nacimiento de hijo', B'1', B'1'),
(2, 'Licencia Sindical', 'LSIN', 'Licencia para actividades sindicales', B'1', B'0'),
(3, 'Licencia por Examen', 'LEXA', 'Licencia para rendir exámenes académicos', B'1', B'0'),
(4, 'Licencia sin Goce', 'LSGO', 'Licencia sin goce de haber', B'1', B'0'),
(5, 'Licencia por Donación', 'LDON', 'Licencia por donación de sangre/órganos', B'1', B'1'),
(6, 'Enfermedad', 'ENF', 'Ausencia por enfermedad', B'1', B'1'),
(7, 'Vacaciones', 'VAC', 'Días de vacaciones', B'1', B'1'),
(8, 'Permiso Personal', 'PER', 'Permiso personal remunerado', B'1', B'1'),
(9, 'Permiso No Remunerado', 'PNR', 'Permiso personal no remunerado', B'1', B'0'),
(10, 'Licencia Médica', 'LIC', 'Licencia médica prolongada', B'1', B'1');
...
(1, 'Horario Turnos Rotativos', 'Turnos rotativos mañana/tarde de 6 horas', B'0'),
(2, 'Horario Medio Tiempo', 'Horario de medio tiempo (4 horas diarias)', B'0'),
(3, 'Horario Oficina Estándar', 'Lunes a Viernes de 9:00 a 18:00 con 1 hora de almuerzo', B'1');
...
(1, 2, 1, '08:00:00', '14:00:00', B'1'), -- Lunes mañana
(2, 2, 1, '14:00:00', '20:00:00', B'1'), -- Lunes tarde
(3, 2, 2, '08:00:00', '14:00:00', B'1'), -- Martes mañana
(4, 2, 2, '14:00:00', '20:00:00', B'1'), -- Martes tarde
(5, 2, 3, '08:00:00', '14:00:00', B'1'), -- Miércoles mañana
(6, 2, 3, '14:00:00', '20:00:00', B'1'), -- Miércoles tarde
(7, 2, 4, '08:00:00', '14:00:00', B'1'), -- Jueves mañana
(8, 2, 4, '14:00:00', '20:00:00', B'1'), -- Jueves tarde
(9, 2, 5, '08:00:00', '14:00:00', B'1'), -- Viernes mañana
(10, 2, 5, '14:00:00', '20:00:00', B'1'), -- Viernes tarde
(11, 2, 6, '00:00:00', '00:00:00', B'0'), -- Sábado
(12, 2, 0, '00:00:00', '00:00:00', B'0'), -- Domingo
-- Horario Medio Tiempo
(13, 3, 1, '09:00:00', '13:00:00', B'1'), -- Lunes
(14, 3, 2, '09:00:00', '13:00:00', B'1'), -- Martes
(15, 3, 3, '09:00:00', '13:00:00', B'1'), -- Miércoles
(16, 3, 4, '09:00:00', '13:00:00', B'1'), -- Jueves
(17, 3, 5, '09:00:00', '13:00:00', B'1'), -- Viernes
(18, 3, 6, '00:00:00', '00:00:00', B'0'), -- Sábado
(19, 3, 0, '00:00:00', '00:00:00', B'0'); -- Domingo
...
(1, 'Año Nuevo', '2023-01-01', B'1', B'1'),
(2, 'Jueves Santo', '2023-04-06', B'0', B'1'),
(3, 'Viernes Santo', '2023-04-07', B'0', B'1'),
(4, 'Día del Trabajo', '2023-05-01', B'1', B'1'),
(5, 'San Pedro y San Pablo', '2023-06-29', B'1', B'1'),
(6, 'Fiestas Patrias', '2023-07-28', B'1', B'1'),
(7, 'Fiestas Patrias', '2023-07-29', B'1', B'1'),
(8, 'Santa Rosa de Lima', '2023-08-30', B'1', B'1'),
(9, 'Combate de Angamos', '2023-10-08', B'1', B'1'),
(10, 'Navidad', '2023-12-25', B'1', B'1');
